...
export class TornEndpoint {
   ...
   * @param params - Optional query parameters
   */
  public async rockpaperscissors(params?: {
    timestamp?: number | string;
  }): Promise<TornRockPaperScissorsResponse> {
    const path = `/torn/rockpaperscissors`;
    const query = {
      ...(params?.timestamp !== undefined && { timestamp: params.timestamp }),
    };
    return this.requester(path, query);
  ...
  public async stats(params?: {
    timestamp?: number | string;
  }): Promise<TornCityStatsResponse> {
    const path = `/torn/stats`;
    const query = {
      ...(params?.timestamp !== undefined && { timestamp: params.timestamp }),
    };
    return this.requester(path, query);
...
export class TornIdsContext {
   ...
   * @param params - Optional query parameters
   */
  public async itemstats(params?: {
    timestamp?: number | string;
  }): Promise<TornItemStatsResponse> {
    const path = `/torn/${this.contextId}/itemstats`;
    const query = {
      ...(params?.timestamp !== undefined && { timestamp: params.timestamp }),
    };
    return this.requester(path, query);
